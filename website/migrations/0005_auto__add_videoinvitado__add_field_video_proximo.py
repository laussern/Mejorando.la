...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VideoInvitado'
        db.create_table('website_videoinvitado', (
        ...
        db.send_create_signal('website', ['VideoInvitado'])

        # Adding M2M table for field videos on 'VideoInvitado'
        db.create_table('website_videoinvitado_videos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('videoinvitado', models.ForeignKey(orm['website.videoinvitado'], null=False)),
            ('video', models.ForeignKey(orm['website.video'], null=False))
        ))
        db.create_unique('website_videoinvitado_videos', ['videoinvitado_id', 'video_id'])

        # Adding field 'Video.proximo'
        db.add_column('website_video', 'proximo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VideoInvitado'
        db.delete_table('website_videoinvitado')

        # Removing M2M table for field videos on 'VideoInvitado'
        db.delete_table('website_videoinvitado_videos')

        # Deleting field 'Video.proximo'
        db.delete_column('website_video', 'proximo')
