...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VideoComentarioSpamIP'
        db.create_table('website_videocomentariospamip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('website', ['VideoComentarioSpamIP'])


    def backwards(self, orm):
        # Deleting model 'VideoComentarioSpamIP'
        db.delete_table('website_videocomentariospamip')
