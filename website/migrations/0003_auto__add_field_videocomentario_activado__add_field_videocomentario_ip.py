...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoComentario.activado'
        db.add_column('website_videocomentario', 'activado',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'VideoComentario.ip'
        db.add_column('website_videocomentario', 'ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoComentario.activado'
        db.delete_column('website_videocomentario', 'activado')

        # Deleting field 'VideoComentario.ip'
        db.delete_column('website_videocomentario', 'ip')
