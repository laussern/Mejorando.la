import os
# Django settings for mejorandola project.

DEBUG = False
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Adan Sanchez', 'adan@mejorando.la'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    'website.context_processors.geo',
...
# tamano de las imagenes de los videos
