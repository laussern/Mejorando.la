...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CursoPago.ip'
        db.add_column('cursos_cursopago', 'ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'CursoPago.ua'
        db.add_column('cursos_cursopago', 'ua',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CursoPago.ip'
        db.delete_column('cursos_cursopago', 'ip')

        # Deleting field 'CursoPago.ua'
        db.delete_column('cursos_cursopago', 'ua')
